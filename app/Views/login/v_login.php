...
<body class="d-flex align-items-center py-4 bg-body-tertiary">
    ...
    <main class="form-signin w-100 m-auto">
        <form action="/login" method="post">
            ...
            <h1 class="mb-3 fw-normal text-center">PENGADUAN SIJAWARA</h1>
            ...
            <p class="mt-5 mb-3 text-body-secondary">&copy; SIJAWARA KABUPATEN SUBANG 2023</p>
        </form>
    </main>
